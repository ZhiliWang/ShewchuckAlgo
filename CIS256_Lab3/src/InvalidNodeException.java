...
All the code is in the tree package.  You can compile it from your lab3
...
The Tree class defines certain nodes to be invalid.  In valid and invalid nodes are
