...
public class SList {
    ...
    public static void main (String[] args) {
        SList slistNum = new SList();
        slistNum.insertFront(new Integer(9));
        slistNum.insertEnd(new Integer(12));
        slistNum.insertFront(new Integer(6));
        System.out.println("First list we created:");
        System.out.println(slistNum);
        slistNum.insertFront(new Integer(3));
        slistNum.insertEnd(new Integer(15));
        System.out.println("After inserting 2 elements:");
        System.out.println(slistNum);
