...
public class DList1 {
    ...
    public void insertFront(int i) {
        ...
        if (size == 0) {
            ...
            DListNode1 newNode1 = new DListNode1(i);
            head.prev = newNode1;
            newNode1.next = head;
            head = newNode1;
        }
    ...
    public void removeFront() {
        ...
        if (size == 0 || size == 1) {
            ...
            head = head.next;
            head.prev = null; // check to see if anything is different if we swap line 94 and 95
                              // no difference, but need more investigation to confirm
            size--;
        }
    }
